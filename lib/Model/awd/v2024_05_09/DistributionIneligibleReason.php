 ...
 */
class DistributionIneligibleReason implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'DistributionIneligibleReason';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('failure_reasons', $data ?? [], null);
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['failure_code']) {
            $invalidProperties[] = "'failure_code' can't be null";
        }
        if (null === $this->container['failure_reasons']) {
     ...
     * Sets failure_code.
     *
     * @param string $failure_code failure code details of the error
     */
    public function setFailureCode(string $failure_code): self
    {
     ...
     *
     * @param array $failure_reasons failure reasons of the error
     */
    public function setFailureReasons(array $failure_reasons): self
    {
        if (is_null($failure_reasons)) {
            throw new \InvalidArgumentException('non-nullable failure_reasons cannot be null');
        }
     ...
     * Sets sku.
     *
     * @param null|string $sku SKU associated with the error
     */
