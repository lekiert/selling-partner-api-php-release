 ...
 */
class OutboundShipmentSummary implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'OutboundShipmentSummary';
     ...
     * Sets created_at.
     *
     * @param null|\DateTime $created_at Timestamp denoting when the shipment was created
     */
     ...
     * Sets order_id.
     *
     * @param string $order_id Order ID of AWD inbound order this inbound shipment belongs to
     */
    public function setOrderId(string $order_id): self
    {
        ...
        if (mb_strlen($order_id) < 1) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling OutboundShipmentSummary., must be bigger than or equal to 1.');
        }
    ...
    public function setShipmentId(string $shipment_id): self
    {
        ...
        if (mb_strlen($shipment_id) < 1) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling OutboundShipmentSummary., must be bigger than or equal to 1.');
        }
     ...
     * Sets updated_at.
     *
     * @param null|\DateTime $updated_at Timestamp denoting when the shipment was updated
     */
