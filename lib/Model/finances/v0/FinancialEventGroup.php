...
class FinancialEventGroup implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param null|\DateTime $fund_transfer_date A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     */
     ...
     *
     * @param null|\DateTime $financial_event_group_start A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     */
     ...
     *
     * @param null|\DateTime $financial_event_group_end A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     */
