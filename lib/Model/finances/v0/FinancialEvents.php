...
class FinancialEvents implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'ebt_refund_reimbursement_only_event_list' => '\SpApi\Model\finances\v0\EBTRefundReimbursementOnlyEvent[]',
    ...
    protected static array $openAPINullables = [
        ...
        'ebt_refund_reimbursement_only_event_list' => true,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ebt_refund_reimbursement_only_event_list', $data ?? [], null);
     ...
     *
     * @param null|array $ebt_refund_reimbursement_only_event_list a list of EBT refund reimbursement events
     */
    public function setEbtRefundReimbursementOnlyEventList(?array $ebt_refund_reimbursement_only_event_list): self
    {
        if (is_null($ebt_refund_reimbursement_only_event_list)) {
            array_push($this->openAPINullablesSetToNull, 'ebt_refund_reimbursement_only_event_list');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ebt_refund_reimbursement_only_event_list', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param null|array $service_provider_credit_event_list a list of `SolutionProviderCreditEvent`
     */
     ...
     *
     * @param null|array $safet_reimbursement_event_list a list of `SAFETReimbursementEvent`
     */
     ...
     *
     * @param null|array $removal_shipment_adjustment_event_list a comma-delimited list of `RemovalShipmentAdjustment` details for FBA inventory
     */
     ...
     *
     * @param null|array $tax_withholding_event_list a list of tax withholding events
     */
     ...
     *
     * @param null|array $failed_adhoc_disbursement_event_list a list of `FailedAdhocDisbursementEvent`
     */
