...
class TaxWithholdingPeriod implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets start_date.
     *
     * @param null|\DateTime $start_date A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     */
     ...
     * Sets end_date.
     *
     * @param null|\DateTime $end_date A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
     */
