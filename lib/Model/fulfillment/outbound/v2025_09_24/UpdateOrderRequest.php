...
class UpdateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfillment_action'] === null) {
            $invalidProperties[] = "'fulfillment_action' can't be null";
        }
     ...
     *
     * @param string $fulfillment_action Specifies whether the fulfillment order should ship now or have an order hold put on it.
     *
     * @return self
     */
