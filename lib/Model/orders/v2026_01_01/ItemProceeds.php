...
class ItemProceeds implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'proceeds_total' => '\SpApi\Model\orders\v2026_01_01\Money',
        'breakdowns' => '\SpApi\Model\orders\v2026_01_01\ItemProceedsBreakdown[]'];
    ...
    {
        $this->setIfExists('proceeds_total', $data ?? [], null);
     ...
     * Gets proceeds_total.
     */
    public function getProceedsTotal(): ?Money
    {
     ...
     * Sets proceeds_total.
     *
     * @param null|Money $proceeds_total proceeds_total
     */
    public function setProceedsTotal(?Money $proceeds_total): self
    {
        if (is_null($proceeds_total)) {
            array_push($this->openAPINullablesSetToNull, 'proceeds_total');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proceeds_total', $nullablesSetToNull);
            if (false !== $index) {
     ...
     * Sets breakdowns.
     *
     * @param null|array $breakdowns the breakdown of proceeds
     */
