...
class SalesChannel implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets marketplace_id.
     *
     * @param null|string $marketplace_id the unique identifier for the specific marketplace within the sales channel where this order was placed
     */
     ...
     *
     * @param null|string $marketplace_name the human-readable name of the marketplace where this order was placed
     */
