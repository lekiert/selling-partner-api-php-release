...
class DeliveryPreference implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'delivery_time' => '\SpApi\Model\orders\v2026_01_01\PreferredDeliveryTime',
    ...
    protected static array $openAPINullables = [
        ...
        'address_instruction' => true,
        'delivery_time' => true,
        'delivery_capabilities' => true,
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('address_instruction', $data ?? [], null);
     ...
     *
     * @param null|string $drop_off_location the drop-off location selected by the customer
     */
     ...
     */
    public function getAddressInstruction(): ?string
    {
     ...
     *
     * @param null|string $address_instruction building instructions, nearby landmark, or navigation instructions
     */
    public function setAddressInstruction(?string $address_instruction): self
    {
        if (is_null($address_instruction)) {
            array_push($this->openAPINullablesSetToNull, 'address_instruction');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_instruction', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets delivery_time.
     */
    public function getDeliveryTime(): ?PreferredDeliveryTime
    {
     ...
     * Sets delivery_time.
     *
     * @param null|PreferredDeliveryTime $delivery_time delivery_time
     */
    public function setDeliveryTime(?PreferredDeliveryTime $delivery_time): self
    {
     ...
     */
    public function getDeliveryCapabilities(): ?array
    {
     ...
     *
     * @param null|array $delivery_capabilities a list of miscellaneous delivery capabilities associated with the shipping address
     */
    public function setDeliveryCapabilities(?array $delivery_capabilities): self
    {
        if (is_null($delivery_capabilities)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_capabilities');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_capabilities', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
