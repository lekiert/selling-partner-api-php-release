...
class ItemCancellation implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    public function getCancellationRequest(): ?ItemCancellationRequest
    {
     ...
     *
     * @param null|ItemCancellationRequest $cancellation_request cancellation_request
     */
    public function setCancellationRequest(?ItemCancellationRequest $cancellation_request): self
    {
        if (is_null($cancellation_request)) {
            array_push($this->openAPINullablesSetToNull, 'cancellation_request');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cancellation_request', $nullablesSetToNull);
            if (false !== $index) {
