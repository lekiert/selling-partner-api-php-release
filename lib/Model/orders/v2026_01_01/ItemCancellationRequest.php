...
class ItemCancellationRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets requester.
     *
     * @param null|string $requester Entity that initiated the cancellation request for this item.   **Possible values**: `BUYER`
     */
     ...
     * Sets cancel_reason.
     *
     * @param null|string $cancel_reason explanation provided for why the cancellation was requested
     */
