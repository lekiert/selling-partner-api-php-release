...
class Recipient implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'delivery_address' => '\SpApi\Model\orders\v2026_01_01\CustomerAddress',
        'delivery_preference' => '\SpApi\Model\orders\v2026_01_01\DeliveryPreference'];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('delivery_preference', $data ?? [], null);
    }
     ...
     *
     * @param null|CustomerAddress $delivery_address delivery_address
     */
    public function setDeliveryAddress(?CustomerAddress $delivery_address): self
    {
     ...
     */
    public function getDeliveryPreference(): ?DeliveryPreference
    {
     ...
     *
     * @param null|DeliveryPreference $delivery_preference delivery_preference
     */
    public function setDeliveryPreference(?DeliveryPreference $delivery_preference): self
    {
        if (is_null($delivery_preference)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_preference');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_preference', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
