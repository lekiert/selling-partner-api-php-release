...
class Alias implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['alias_id']) {
            $invalidProperties[] = "'alias_id' can't be null";
        }
        if (null === $this->container['alias_type']) {
     ...
     */
    public function setAliasId(string $alias_id): self
    {
        if (is_null($alias_id)) {
     ...
     */
    public function setAliasType(string $alias_type): self
    {
