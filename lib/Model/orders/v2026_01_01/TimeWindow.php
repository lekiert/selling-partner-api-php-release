...
class TimeWindow implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'start_time' => '\SpApi\Model\orders\v2026_01_01\HourMinute',
        'end_time' => '\SpApi\Model\orders\v2026_01_01\HourMinute'];
     ...
     * Gets start_time.
     */
    public function getStartTime(): ?HourMinute
    {
     ...
     * Sets start_time.
     *
     * @param null|HourMinute $start_time start_time
     */
    public function setStartTime(?HourMinute $start_time): self
    {
     ...
     * Gets end_time.
     */
    public function getEndTime(): ?HourMinute
    {
     ...
     * Sets end_time.
     *
     * @param null|HourMinute $end_time end_time
     */
    public function setEndTime(?HourMinute $end_time): self
    {
        if (is_null($end_time)) {
