...
class DateTimeRange implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'earliest_date_time' => true,
        'latest_date_time' => true,
    ];
    ...
    {
        $this->setIfExists('earliest_date_time', $data ?? [], null);
        $this->setIfExists('latest_date_time', $data ?? [], null);
    }
     ...
     */
    public function getEarliestDateTime(): ?\DateTime
    {
     ...
     *
     * @param null|\DateTime $earliest_date_time The beginning of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
    public function setEarliestDateTime(?\DateTime $earliest_date_time): self
    {
        if (is_null($earliest_date_time)) {
            array_push($this->openAPINullablesSetToNull, 'earliest_date_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('earliest_date_time', $nullablesSetToNull);
            if (false !== $index) {
     ...
     */
    public function getLatestDateTime(): ?\DateTime
    {
     ...
     *
     * @param null|\DateTime $latest_date_time The end of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
    public function setLatestDateTime(?\DateTime $latest_date_time): self
    {
        if (is_null($latest_date_time)) {
            array_push($this->openAPINullablesSetToNull, 'latest_date_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('latest_date_time', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
