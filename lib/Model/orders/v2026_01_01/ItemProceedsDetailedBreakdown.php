...
class ItemProceedsDetailedBreakdown implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'subtype' => 'string',
        'value' => '\SpApi\Model\orders\v2026_01_01\Money'];
     ...
     * Sets subtype.
     *
     * @param null|string $subtype Specific classification of the further granular breakdown.   **Possible values**: `ITEM`, `SHIPPING`, `GIFT_WRAP`, `COD_FEE`, `OTHER`, `DISCOUNT`
     */
