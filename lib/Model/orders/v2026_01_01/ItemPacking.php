...
class ItemPacking implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Gets gift_option.
     */
    public function getGiftOption(): ?GiftOption
    {
     ...
     * Sets gift_option.
     *
     * @param null|GiftOption $gift_option gift_option
     */
    public function setGiftOption(?GiftOption $gift_option): self
    {
        if (is_null($gift_option)) {
            array_push($this->openAPINullablesSetToNull, 'gift_option');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gift_option', $nullablesSetToNull);
            if (false !== $index) {
