...
class BusinessHour implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets day_of_week.
     *
     * @param null|string $day_of_week specific day of the week for which operating hours are being defined
     */
     ...
     * Sets time_windows.
     *
     * @param null|array $time_windows collection of time windows during which the location is available for deliveries on the specified day
     */
