...
class ItemProduct implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'title' => 'string',
        'seller_sku' => 'string',
        'condition' => '\SpApi\Model\orders\v2026_01_01\ItemCondition',
        'price' => '\SpApi\Model\orders\v2026_01_01\ItemPrice',
        'serial_numbers' => 'string[]',
        'customization' => '\SpApi\Model\orders\v2026_01_01\ItemCustomization'];
     ...
     * Sets serial_numbers.
     *
     * @param null|array $serial_numbers unique serial numbers for products that require individual tracking, typically provided for FBA orders
     */
    ...
    public function setCustomization(?ItemCustomization $customization): self
    {
        if (is_null($customization)) {
            array_push($this->openAPINullablesSetToNull, 'customization');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customization', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
