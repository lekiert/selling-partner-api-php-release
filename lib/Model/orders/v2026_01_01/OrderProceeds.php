...
class OrderProceeds implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets grand_total.
     *
     * @param null|Money $grand_total grand_total
     */
    public function setGrandTotal(?Money $grand_total): self
    {
        if (is_null($grand_total)) {
            array_push($this->openAPINullablesSetToNull, 'grand_total');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('grand_total', $nullablesSetToNull);
            if (false !== $index) {
