...
/**
    ...
    public function getOrderPreviewRequest($body, $x_amzn_fulfillment_service_id = null, string $contentType = self::contentTypes['getOrderPreview'][0])
    {
        ...
        if ($x_amzn_fulfillment_service_id !== null && strlen($x_amzn_fulfillment_service_id) > 40) {
            throw new \InvalidArgumentException('invalid length for "$x_amzn_fulfillment_service_id" when calling FulfillmentPreviewsApi.getOrderPreview, must be smaller than or equal to 40.');
        }
